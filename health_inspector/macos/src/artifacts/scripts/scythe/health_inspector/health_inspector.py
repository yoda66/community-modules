...
def create_parser(db, os="windows"):
    ...
    epilog =  'Example usage: scythe.health_inspector'
    parser = ArgumentParser(prog="health_inspector", description="Perform host recon on macOS",
                            epilog=epilog)
    return parser
...
def tags(db, request, response):
    ...
    :rtype: list
    """
    r = ["scythe", "att&ck", "att&ck-technique:T1059"]
    return r
